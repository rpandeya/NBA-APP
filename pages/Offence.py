...
with row4_1:
    ...
    st.write(draw_bar(player_offence, clust_off, league_avg_off,offence_freq,offence_freq_perc, player,off_percentile, total_offence_cluster, league, dtype))
...
with row5_1:
    ...
    league_ppp = st.checkbox('Show League Average PPP')
    ...
    st.write(draw_bar(player_offence, clust_off, league_avg_off,offence_ppp,offence_ppp_perc, player,off_percentile, total_offence_cluster, league_ppp, dtype_ppp))
